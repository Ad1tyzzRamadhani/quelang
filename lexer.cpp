...
const std::unordered_map<std::string,TokenType> Lexer::keyword_map={
    ...
    {"const",TokenType::KW_CONST},{"volatile",TokenType::KW_VOLATILE},
    {"and",TokenType::KW_AND},{"or",TokenType::KW_OR},{"xor",TokenType::KW_XOR},
    {"override",TokenType::KW_OVERRIDE},{"noreturn",TokenType::KW_NORETURN},
    {"default",TokenType::KW_DEFAULT},{"virtual",TokenType::KW_VIRTUAL},
    ...
    {"new",TokenType::KW_NEW},{"protected",TokenType::KW_PROTECTED},
    {"construct",TokenType::KW_CONSTRUCT},{"rtti",TokenType::KW_RTTI},
};
