...
enum class TokenType {
    ...
    KW_IF, KW_ELIF, KW_ELSE, KW_ASM,
    KW_WHILE, KW_DO, KW_FOR,KW_FALL,
    ...
    KW_NEW, KW_DELETE, KW_NOT, KW_MOVE, KW_NOCOPY,
...
const std::unordered_map<std::string,TokenType> Lexer::keyword_map={
    ...
    {"continue",TokenType::KW_CONTINUE},{"extern",TokenType::KW_EXTERN},{"nocopy",TokenType::KW_NOCOPY},
    ...
    {"and",TokenType::KW_AND},{"or",TokenType::KW_OR},{"xor",TokenType::KW_XOR},{"asm",TokenType::KW_ASM},
